...
import discord
import requests
from database import post_search_data, fetch_search_data
from search import search_main

TOKEN = 'Nzg3NjY4Njk3NzMyNzQzMTY5.X9YTow.QUWB-Ob1a2J2Z544GjbPNv6_jmQ'

s=requests.session()
s.verify='path/to/CAs'

r = requests.get('https://www.google.co.in/',verify=False)
